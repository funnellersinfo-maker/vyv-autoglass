...
export const DICT: Dict = {
  ...
  // Hero
  "hero.badge": { es: "#1 Auto Glass en San Diego · 15,000+ vehículos atendidos", en: "#1 Auto Glass in San Diego · 15,000+ vehicles served" },
  ...
  "hero.trust.installs": { es: "15,000+", en: "15,000+" },
  "hero.trust.installsSub": { es: "Vehículos atendidos", en: "Vehicles served" },
  ...
  "expert.title": { es: "Victor: más de 25 años de experiencia en vidrios automotrices", en: "Victor: over 25 years of auto glass experience" },
  "expert.role": { es: "Fundador & Dueño · Desde 2007", en: "Founder & Owner · Since 2007" },
  "expert.p1": { es: "Victor fundó en el año 2007 la compañía V&V Autoglass, y hoy suma más de 25 años de experiencia en el mercado de los autos-cristales, con 18 años de experiencia manejando su propia empresa. V&V le ofrece a la comunidad de San Diego un servicio honesto, de buena calidad y a precio razonable.", en: "Victor founded V&V Autoglass in 2007, and today he brings more than 25 years of experience in the auto glass market, including 18 years running his own company. V&V offers the San Diego community honest, quality service at a reasonable price." },
  "expert.p2": { es: "En estos 25 años hemos tocado un poco más de 15,000 vehículos, siempre ofreciendo lo mejor de nosotros: un gran profesionalismo, siempre priorizando a nuestros clientes, usando los mejores materiales y ofreciendo las mejores garantías.", en: "In these 25 years we have worked on just over 15,000 vehicles, always giving our best: great professionalism, always putting our customers first, using the best materials and offering the best warranties." },
  "expert.p3": { es: "Desde un principio nuestra filosofía ha sido buen servicio a precio razonable y, como negocio familiar, siempre nos ha preocupado la seguridad de la familia en cada vehículo que tocamos.", en: "From the very beginning our philosophy has been good service at a fair price, and as a family business, the safety of the family in every vehicle we touch has always come first." },
  "expert.stat1": { es: "25+ años", en: "25+ years" },
  "expert.stat1l": { es: "de experiencia", en: "of experience" },
  "expert.stat2": { es: "15,000+", en: "15,000+" },
  "expert.stat2l": { es: "vehículos atendidos", en: "vehicles served" },
  "expert.stat3": { es: "2007", en: "2007" },
  "expert.stat3l": { es: "año de fundación", en: "year founded" },
  "expert.quote": { es: "\"Buen servicio a precio razonable. La seguridad de tu familia va primero.\"", en: "\"Good service at a fair price. Your family's safety comes first.\"" },
  ...
  "book.draft.title": { es: "Tienes un borrador sin terminar:", en: "You have an unfinished draft:" },
  "book.draft.restore": { es: "Restaurar", en: "Restore" },
  "book.draft.discard": { es: "Descartar", en: "Discard" },
  ...
  "road.quote": { es: "Cotizador", en: "Estimator" },

  // QuoteEstimator (cotizador express)
  "quote.kicker": { es: "Cotizador Express", en: "Instant Estimator" },
  "quote.title": { es: "¿Cuánto cuesta tu vidrio? Descúbrelo en 10 segundos.", en: "How much is your glass? Find out in 10 seconds." },
  "quote.sub": { es: "3 toques y tienes tu estimado al instante. Precio exacto por WhatsApp en menos de 1 min.", en: "3 taps and you get your estimate instantly. Exact price via WhatsApp in under 1 min." },
  "quote.glass": { es: "Tipo de vidrio", en: "Glass type" },
  "quote.brand": { es: "Gama del vehículo", en: "Vehicle tier" },
  "quote.year": { es: "Año del vehículo", en: "Vehicle year" },
  "quote.glass.windshield": { es: "Parabrisas", en: "Windshield" },
  "quote.glass.side": { es: "Cristal lateral", en: "Side window" },
  "quote.glass.back": { es: "Vidrio trasero", en: "Back glass" },
  "quote.glass.chip": { es: "Reparación de grieta", en: "Chip repair" },
  "quote.tier.eco": { es: "Económica", en: "Economy" },
  "quote.tier.mid": { es: "Intermedia", en: "Mid-range" },
  "quote.tier.premium": { es: "Premium", en: "Premium" },
  "quote.tier.eco.ex": { es: "Toyota · Honda · Nissan · Kia", en: "Toyota · Honda · Nissan · Kia" },
  "quote.tier.mid.ex": { es: "Ford · Chevrolet · Jeep · VW", en: "Ford · Chevrolet · Jeep · VW" },
  "quote.tier.premium.ex": { es: "BMW · Mercedes · Audi · Lexus", en: "BMW · Mercedes · Audi · Lexus" },
  "quote.year.old": { es: "1990–2009", en: "1990–2009" },
  "quote.year.mid": { es: "2010–2019", en: "2010–2019" },
  "quote.year.new": { es: "2020–2026", en: "2020–2026" },
  "quote.of": { es: "de 3", en: "of 3" },
  "quote.result.label": { es: "Tu estimado", en: "Your estimate" },
  "quote.result.hint": { es: "Elige las 3 opciones y tu precio aparece al instante", en: "Pick all 3 and your price appears instantly" },
  "quote.result.micro": { es: "Precio final confirmado por WhatsApp · Sin compromiso", en: "Final price confirmed via WhatsApp · No commitment" },
  "quote.cta.wa": { es: "Cotización exacta por WhatsApp", en: "Exact quote via WhatsApp" },
  "quote.cta.call": { es: "Llamar ahora", en: "Call now" },
  "quote.trust.free": { es: "Cotización gratis", en: "Free quote" },
  "quote.trust.minute": { es: "Respuesta en 1 min", en: "Reply in 1 min" },
  "quote.trust.warranty": { es: "Garantía de por vida", en: "Lifetime warranty" },
